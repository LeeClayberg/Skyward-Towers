...
namespace UnityEditor.Purchasing
{
    ...
    /// </summary>
	[CustomEditor(typeof(CustomIAPButton))]
    [CanEditMultipleObjects]
    public class CustomIAPButtonEditor : Editor
    {
        ...
        {
            CustomIAPButton button = (CustomIAPButton)target;

            serializedObject.Update();

            if (button.buttonType == CustomIAPButton.ButtonType.Purchase)
            {
            ...
            DrawPropertiesExcluding(serializedObject, button.buttonType == CustomIAPButton.ButtonType.Restore ? restoreButtonExcludedFields : excludedFields);
